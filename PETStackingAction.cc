...
PETStackingAction::ClassifyNewTrack(const G4Track * aTrack)
{
  ...
  std::ofstream myfile8("Edata15_40x3_pix_time_air.txt", std::ios_base::app);
  myfile8 << CPName << "," << EventID << "," << Sec_energy << std::endl;
  myfile8.close();
      }
  ...
  //  std::cout << Time1 << std::endl;
    ...
    std::ofstream myfile1("gammacount_15_40x3_pix_time_air.txt", std::ios_base::app);
